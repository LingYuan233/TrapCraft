...
public class HighExplodeMineM extends Block{
    ...
    public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
        if (!(entity instanceof PlayerEntity) && !(entity instanceof ItemEntity) && !(entity instanceof AnimalEntity)) {
